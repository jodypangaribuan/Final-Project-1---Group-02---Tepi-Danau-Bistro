...
@section('content')
    ...
    <section id="book-a-table" class="book-a-table">
        <div class="container" data-aos="fade-up">
            ...
            <form action="{{ route('book-table') }}" method="get" role="form" class="php-email-form-v2"
                    ...
                    @foreach ($testimoni as $item)
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{ asset('assets/img/testimoni/'.$item->foto) }}" class="testimonial-img"
                                     alt="">
                                <h3>{{ $item->nama }}</h3>
                            </div>
                ...
                @foreach ($galery as $g)
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('assets/img/galery/'.$g->img) }}" class="gallery-lightbox"
    ...
    <section id="contact" class="contact">
        ...
        <div data-aos="fade-up">
            <iframe style="border:0; width: 100%; height: 350px;"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1072.5138029372895!2d99.05637513405325!3d2.3343521486342818!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x302e051111b888f7%3A0x7b92db9623ce4f01!2sTepi%20Danau%20Bistro!5e0!3m2!1sid!2sid!4v1714011010601!5m2!1sid!2sid"
