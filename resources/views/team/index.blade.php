                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form role="form text-left" method="POST" action="{{ route('team-store') }}" enctype="multipart/form-data">
                                    @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Posisi" name="posisi" id="Posisi" value="{{ old('Posisi') }}" required>
                                        @error('Posisi')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{ asset('assets/img/team/'.$item->foto) }}" style="max-width: 100px" alt="">
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0" style="text-align: left">{{ $item->nama }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0" style="text-align: left">{{ $item->posisi }}</p>
                                    </td>
                                    <td class="text-center">
                                    <a href="#" type="button" data-bs-toggle="modal" data-bs-target="#modaledit{{ $item->id }}">
                                        <i class="fas fa-user-edit text-secondary"></i>
                                    </a>
                                    <a href="{{ route('team-delete',$item->id) }}" type="button" >
...
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form role="form text-left" method="POST" action="{{ route('team-update',$item2->id) }}" enctype="multipart/form-data">
            @csrf
        <div class="modal-body">
            <div class="mb-3">
                <label for="">Foto</label>
                <br>
                <img src="{{ asset('assets/img/team/'.$item2->foto) }}" style="max-width: 100px" alt="">
                <br>
                <input type="file" class="form-control" placeholder="foto" name="foto" id="foto" value="{{ old('foto') }}" required>
                @error('foto')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
            ...
            <div class="mb-3">
                <label for="">Posisi</label>
                <input type="text" class="form-control" placeholder="Posisi" name="posisi" id="Posisi" value="{{ old('Posisi') ?? $item2->posisi }}" required>
                @error('Posisi')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                @enderror
            </div>
